...
export const saveMessageInternal = async ({ conversationId, userId, role, content, images = [], artifacts = [] }) => {
  if (!conversationId || !role || !content || !userId) {
    throw new Error("conversationId, userId, role, and content are required.");
  }
...
export const saveMessage = async (req, res) => {
  try {
    ...
    const message = await saveMessageInternal({ conversationId, userId, role, content, images, artifacts });
