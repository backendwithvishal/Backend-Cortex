...
import { processPlanUpdate } from "../auth/auth.controller.js";
...
export const verifyPayment = async (req, res) => {
  try {
    ...
    // Update user plan and credits directly in-process
    await processPlanUpdate(payment.userId, payment.plan, payment.credits);

    // Optional event emission to RabbitMQ
    rabbitMQ.publish("billing.payment.verified", {
