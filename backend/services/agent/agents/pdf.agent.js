...
/**
 * PDF Agent: generates PDF document from AI response using PDFKit and saves it to storage.
 */
...
`);
    ...
    doc.moveDown(2);
    doc.fontSize(10).fillColor("#9CA3AF").text("Generated by CortexAI", { align: "center" });
    doc.end();
...
`.trim(),
    ...
    return {
      ...state,
      response: "❌ Failed to generate PDF: " + error.message,
    };
  }
};